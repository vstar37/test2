...
if __name__ == '__main__':
    ...
    #optimization
    parser.add_argument('--batch_size', type=int, default=5, help='Number of samples/tasks in one batch')
    parser.add_argument('--n_workers', type=int, default=12, help='number of workers to load data')
    ...
    parser.add_argument('--dgcnn_k', type=int, default=10, help='Number of nearest neighbors in Edgeconv')
    ...
    parser.add_argument('--resume_path', default='resume_path', help='resume pth path')
    parser.add_argument('--saved_iter', default=None, help='resume pth path')
